...
(function() {
  ...
  class VisitorCounter {
    constructor() {
      ...
      this.ownerFlagKey = 'rohan-site-owner-mode';
      this.init();
    }

    init() {
      // Check if this is the owner (via URL parameter or localStorage flag)
      const isOwner = this.checkIfOwner();

      if (isOwner) {
        console.log('[SiteStats] Owner mode - visit not counted');
      }
